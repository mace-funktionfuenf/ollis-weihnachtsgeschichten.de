...
- **Impressum/Datenschutz has no real legal text** — the export only had 4 lines of
  static address info; both bodies were 100% eRecht24-plugin-generated. Flagged inline in
  `/impressum/` with a visible placeholder. Needs commissioning, not auto-generation.
