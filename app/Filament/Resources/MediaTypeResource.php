...
use App\Filament\Resources\MediaTypeResource\RelationManagers;
...
class MediaTypeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Medienart';

    protected static ?string $pluralModelLabel = 'Medienarten';
